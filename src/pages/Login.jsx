...
import { GoogleLogin } from "@react-oauth/google"; // NAYA: Google login import
...
const Login = () => {
  ...
  // NAYA FUNCTION: Google Login ko Backend se connect karne ke liye
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="w-full flex justify-center">
                  <GoogleLogin
                    ...
                    onError={() =>
                      setErrorMessage("Google Login was closed or failed.")
                    }
                    theme="filled_black"
                    size="large"
                    width="400"
